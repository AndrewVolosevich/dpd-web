...
import { useCreateEmployeeInfoCard } from '@/lib/api/queries/Content/mutations/useCreateEmployeeInfoCard';
import { useUpdateEmployeeInfoCard } from '@/lib/api/queries/Content/mutations/useUpdateEmployeeInfoCard';
import { useDeleteEmployeeInfoCard } from '@/lib/api/queries/Content/mutations/useDeleteEmployeeInfoCard';
